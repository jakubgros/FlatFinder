...
class ScrappingManager:
    def __init__(self, check_interval, filters):
        self.attribute_filters = filters
        self.check_interval = check_interval
        self.gumtree_flat_provider = GumtreeFlatProvider(filters)
    ...
    def _get_new_flat_links(self):
        fetched_flat_links = self.gumtree_flat_provider.most_recent_flat_links()
        new_flat_links = fetched_flat_links.difference(self.processed_flat_link)
        self.processed_flat_links.extend(new_flat_links)
    ...
    def _filter_and_print(self, flat):
        ...
        if all(filtered_value is not None for filtered_value in filtered_data.values()):
