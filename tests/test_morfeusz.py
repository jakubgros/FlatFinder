...
class MorfeuszTest(unittest.TestCase):
    ...
    def test_3_words_comparison(self):
        self.assertTrue(
            MorphologicComparator().equals("Stanisława Ignacego Krasickiego", "Stanisławem Ignacym Krasickim"))
        self.assertFalse(
            MorphologicComparator().equals("Stanisława Piotra Krasickiego", "Stanisławem Ignacym Krasickim"))
